...
const AskBox = ({ onClick }) => {
  return (
    <div
      className="mt-10 max-w-5xl mx-auto border border-green-600 rounded-md p-6"
    ...
    >
      <div className="flex flex-col sm:flex-row justify-between items-center text-white gap-4">
        ...
        <button
          onClick={onClick}
          className="bg-white text-green-700 px-6 py-2 rounded-full text-sm font-medium hover:opacity-90"
        >
          Đặt câu hỏi
        </button>
      </div>

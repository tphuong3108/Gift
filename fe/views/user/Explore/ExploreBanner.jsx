    ...
    <div className="bg-[#F4FCEF] px-4 sm:px-6 py-6">
      <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
        ...
        <div className="flex-1 font-[Montserrat] text-center md:text-left">
          <h2 className="text-[24px] sm:text-[28px] md:text-[30px] leading-[120%] font-semibold text-[#007E2F] break-words">
            Khám phá đồ tặng miễn phí
          </h2>
          <p className="text-[16px] sm:text-[17px] md:text-[18px] leading-[140%] mt-2 text-[#1A1A1A]">
            Tìm kiếm, lọc và chọn món đồ bạn cần từ cộng đồng. Tất cả đều miễn phí, thân thiện và dễ sử dụng!
          </p>
          <button className="mt-4 bg-[#059669] hover:bg-[#007E2F] text-white text-sm font-semibold px-5 py-2 rounded-full w-fit mx-auto md:mx-0">
            Bắt đầu khám phá
          </button>
        </div>
